...
# book_recommendation_ml documentation build
...
from book_recommendation_ml import __version__ as release

# -- Project information -----------------------------------------------------

project = "book_recommendation_ml"
author = "Kedro"
...
htmlhelp_basename = "book_recommendation_mldoc"
...
latex_documents = [
    (
        master_doc,
        "book_recommendation_ml.tex",
        "book_recommendation_ml Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "book_recommendation_ml",
        "Project book_recommendation_ml codebase.",
        "Data-Science",
    )
]
